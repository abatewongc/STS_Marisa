...
public class BlazeAway extends CustomCard {
  ...
  public void use(AbstractPlayer p, AbstractMonster m) {
    if (lastAttack != null) {
      io.aleosiss.sts.character.marisa.logger.info("BlazeAway : last attack :" + lastAttack.cardID);
      ...
      */
      ...
      io.aleosiss.sts.character.marisa.logger.info("BlazeAway : error : last attack is null ");
    }
