...
import io.aleosiss.sts.character.marisa.powers.Marisa.BlazeAwayPower;
...
public class BlazeAway_1 extends CustomCard {
  ...
  public void use(AbstractPlayer p, AbstractMonster m) {
    ...
    if (io.aleosiss.sts.character.marisa.Amplified(this, AMP)) {
      stack += AMP_STC;
    }

    io.aleosiss.sts.character.marisa.logger.info("BlazeWay : Applying power : " + stack);
