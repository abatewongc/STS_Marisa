package io.aleosiss.sts.character.marisa.powers.deprecated;
...
public class DiasporaPower extends AbstractPower {
  ...
  public DiasporaPower(AbstractCreature owner, int amount) {
    ...
    updateDescription();
    this.img = new Texture("marisa/img/powers/guardianCloseUp.png");
  }

  public void atEndOfRound() {
    if (this.owner.isPlayer) {
      io.aleosiss.sts.character.marisa.logger.info("DiasporaPower : AtEndOfRound : Why this applied to player?!");
      return;
    }
