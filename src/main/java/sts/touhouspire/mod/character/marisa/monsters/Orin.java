package sts.touhouspire.mod.character.marisa.monsters;

import sts.touhouspire.mod.character.marisa.MarisaModHandler;
import sts.touhouspire.mod.character.marisa.action.OrinsDebuffAction;
import sts.touhouspire.mod.character.marisa.action.SummonFairyAction;
import sts.touhouspire.mod.character.marisa.data.Identifiers;
import sts.touhouspire.mod.character.marisa.powers.monsters.InfernoClaw;
...
public class Orin extends AbstractMonster/* implements BaseMod.GetMonster */ {
  ...
  private static final Logger logger = MarisaModHandler.logger;
  public static final String ID = Identifiers.Monsters.ORIN;
  ...
  */
  ...
  private static final String tempImgUrl = "marisa/img/monsters/Orin/Orin_.png";
  private static final String MODEL_HUMANOID_ATLAS = "marisa/img/monsters/Orin/Orin.atlas";
  private static final String MODEL_HUMANOID_JSON = "marisa/img/monsters/Orin/Orin.json";
  private static final String MODEL_CAT_ATLAS = "marisa/img/monsters/Orin/rincat.atlas";
  ...
  protected void getMove(int num) {
    ...
    if (this.form1) {
      ...
      */
      ...
      MarisaModHandler.logger.info("Orin : getMove : fairyCount : " + fairyCount);
      /*
      if (this.firstTurn) {
        setSummonAction();
        return;
