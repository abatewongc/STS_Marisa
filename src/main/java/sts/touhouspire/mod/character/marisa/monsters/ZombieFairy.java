...
public class ZombieFairy extends AbstractMonster {
	...
	public static final String ID = Identifiers.Monsters.ZOMBIE_FAIRY;
	...
	private static final String MODEL_ATLAS = "marisa/img/monsters/ZombieFairy/ZombieFairy.atlas";
	private static final String MODEL_JSON = "marisa/img/monsters/ZombieFairy/ZombieFairy.json";
	...
	protected void getMove(int num) {
		MarisaModHandler.logger.info("ZombieFairy : GetMove : num : " + num + " ; turnNum : " + turnNum);
		this.turnNum++;
		if (this.turnNum < 3) {
