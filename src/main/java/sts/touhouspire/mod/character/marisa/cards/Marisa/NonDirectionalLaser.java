...
import sts.touhouspire.mod.character.marisa.action.DamageRandomEnemyAction;
...
public class NonDirectionalLaser extends MarisaCard {

	public static final String ID = Identifiers.Cards.NONDIRECTIONAL_LASER;
	private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
	public static final String NAME = cardStrings.NAME;
	public static final String DESCRIPTION = cardStrings.DESCRIPTION;
	public static final String IMG_PATH = "marisa/img/cards/NonDirectLaser.png";
