...
import sts.touhouspire.mod.character.marisa.action.OccultationAction;
import sts.touhouspire.mod.character.marisa.data.Identifiers;
import sts.touhouspire.mod.character.marisa.patches.AbstractCardEnum;

public class Occultation extends MarisaCard {

	public static final String ID = Identifiers.Cards.OCCULTATION;
	public static final String IMG_PATH = "marisa/img/cards/occultation.png";
