...
public class EnergyRecoil extends MarisaModCard {

	public static final String ID = Identifiers.Cards.ENERGY_RECOIL;
	public static final String IMG_PATH = "marisa/img/cards/recoil.png";
