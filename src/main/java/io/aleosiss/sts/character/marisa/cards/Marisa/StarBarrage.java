...
public class StarBarrage extends CustomCard {

	public static final String ID = Identifiers.Cards.STAR_BARRAGE;
	private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
	public static final String NAME = cardStrings.NAME;
	public static final String DESCRIPTION = cardStrings.DESCRIPTION;
	public static final String IMG_PATH = "marisa/img/cards/StarBarrage.png";
	...
	public AbstractCard makeCopy() {
		return new io.aleosiss.sts.character.marisa.cards.Marisa.StarBarrage();
	}
