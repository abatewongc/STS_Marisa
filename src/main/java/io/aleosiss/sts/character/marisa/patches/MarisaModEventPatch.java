  ...
  public static class EventPatch {
    ...
    public static void EventListPatch(AbstractDungeon _exordium) {
      ...
      logger.info("MarisaModEventPatch : current event list : " + events);
	    ...
	    if (AbstractDungeon.player instanceof io.aleosiss.sts.character.marisa.characters.Marisa) {
      ...
      */
	    if (
			    ((_retVal instanceof Mushrooms_MRS) && (AbstractDungeon.floorNum <= 6)) ||
					    ...
					    ((_retVal instanceof OrinTheCat) && (!(AbstractDungeon.player instanceof io.aleosiss.sts.character.marisa.characters.Marisa)) && (!MarisaModHandler.isCatEventEnabled))
	    ) {
